    ...
    <div className="border py-5 bg-gradient-to-b from-rose-100 to-white px-4 md:px-8">
      <div className="flex flex-col md:flex-row justify-center md:justify-evenly items-center space-y-6 md:space-y-0">
        <div className="text-center md:text-left space-y-4">
          <h1 className="prata-regular text-3xl md:text-5xl font-medium">Exclusive</h1>
          <h1 className="prata-regular text-3xl md:text-5xl font-medium">Offers For You</h1>
          <p className="text-base md:text-xl">Only On Best Sellers Products</p>
